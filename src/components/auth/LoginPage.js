...
const loginForm = reduxForm({
  ...
  dispatch => ({
     onSubmit: (values) => dispatch(push({pathname: '/questionare', state: {values: values}}))
...
const LoginButton = props => {
  ...
  return <div className={`ui fluid blue submit ${buttonClass} button`} onClick={props.values.email !== '' || props.values.phone !== '' ? props.handleSubmit : ''}>Questionare</div>
}
